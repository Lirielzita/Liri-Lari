$(function () { // quando o documento estiver pronto/carregado
    ...
    $(document).on("click", "#btIncluirPessoa", function () {
        ...
        data_nascimento = $("#campoData_nascimento").val();
        // preparar dados no formato json
        var dados = JSON.stringify({ nome: nome, email: email, telefone: tel, data_nascimento: data_nascimento });
